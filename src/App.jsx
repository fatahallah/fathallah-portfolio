          ...
          <div className="mt-7 flex flex-wrap items-center gap-3">
            ...
            {project.github ? (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-ink dark:bg-gold text-paper dark:text-ink-dark px-4 py-2.5 rounded-sm text-sm font-medium transition-colors"
              >
                <Github size={15} />
                {t.viewCode}
